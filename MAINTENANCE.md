...
Un repositorio se incluye porque interactúa con instituciones, servicios, infraestructura, normativas o datos propios de Ceuta y Melilla. No basta con que el autor sea de Ceuta y Melilla o resida aquí. Un framework genérico creado por un developer de Ceuta y Melilla no pertenece a esta lista. Un cliente para una API de servicios de Ceuta y Melilla sí.
