...
El criterio fundamental es: **se acepta software que da soporte específico a Ceuta y Melilla, no software hecho por alguien de Ceuta y Melilla.**

Un repositorio se incluye porque interactúa con instituciones, servicios, infraestructura, normativas o datos propios de Ceuta y Melilla. No basta con que el autor resida o trabaje aquí. Un framework genérico creado por un developer de Ceuta y Melilla no pertenece a esta lista. Un cliente para la API de datos abiertos del gobierno de Ceuta y Melilla o una integración con servicios públicos de Ceuta y Melilla sí.

- **Sí:** Clientes de APIs de instituciones de Ceuta y Melilla, integraciones con servicios públicos regionales, scrapers de transporte o datos abiertos de Ceuta y Melilla.
- **No:** Librerías genéricas creadas por equipos de Ceuta y Melilla, software genérico cuyo autor simplemente reside en la comunidad.

Ver `AGENTS.md` (si existe) para criterios detallados adicionales.

## Revisar PRs

1. Comprobar que el proyecto **da soporte específico a Ceuta y Melilla** (no simplemente que el autor es de Ceuta y Melilla).
2. Verificar que la PR incluye la **URL del servicio o institución de Ceuta y Melilla** que el proyecto soporta.
...
4. Si el propietario del proyecto no ha sido notificado, abrir un issue de cortesía en su repo:
   - Título: `Incluido en awesome-ceuta-y-melilla`
...
| No cumple criterios de inclusión | Eliminados por no ser específicos de Ceuta y Melilla |
