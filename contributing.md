# Contribuir a Awesome Ceuta y Melilla
...
- El proyecto debe **dar soporte específico a Ceuta o Melilla** o incluir funcionalidades relevantes para usuarios en estas ciudades autónomas.
...
5. **Incluye en la descripción de la PR la URL del servicio, API o institución de Ceuta o Melilla** a la que el software da soporte (p.ej. ceuta.es, melilla.es, ingesa.sanidad.gob.es). Esto ayuda a verificar que el proyecto es relevante.
